...
struct FGBAHeaderViewListItem : public TSharedFromThis<FGBAHeaderViewListItem>
{
	...
	/** Returns whether generated class is supporting handling of FGBAGameplayClampedAttributeData (child of UGBAAttributeSetBlueprintBase) */
	static bool IsSupportingClampedAttributeData(const TSharedPtr<FGBAAttributeSetWizardViewModel>& InViewModel);
