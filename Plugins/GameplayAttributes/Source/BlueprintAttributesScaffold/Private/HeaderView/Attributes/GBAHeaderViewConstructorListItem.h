...
struct FGBAHeaderViewConstructorListItem : public FGBAHeaderViewListItem
{
	explicit FGBAHeaderViewConstructorListItem(const TSharedPtr<FGBAAttributeSetWizardViewModel>& InViewModel);
