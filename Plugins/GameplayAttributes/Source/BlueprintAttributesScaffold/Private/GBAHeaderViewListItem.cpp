...
bool FGBAHeaderViewListItem::IsSupportingClampedAttributeData(const TSharedPtr<FGBAAttributeSetWizardViewModel>& InViewModel)
{
	...
	return ParentClassInfo.BaseClass && ParentClassInfo.BaseClass->IsChildOf(UGBAAttributeSetBlueprintBase::StaticClass());
}
...
TSharedPtr<FGameplayAttributeData> FGBAHeaderViewListItem::GetGameplayAttributeData(const FProperty& InProperty)
{
